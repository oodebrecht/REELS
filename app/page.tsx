      ...
      <div className="pt-16 max-w-md mx-auto">
        <div className="px-4 py-6 bg-gradient-to-b from-black via-gray-900 to-black">
          <div className="text-center mb-4">
            <div className="bg-gradient-to-r from-yellow-400 to-red-500 h-1 w-20 mx-auto mb-3"></div>
            ...
            <div className="bg-gradient-to-r from-yellow-400 to-red-500 h-1 w-32 mx-auto mb-4"></div>
